(() => {
  ...
  class CaptureSession {
    constructor({id,generation,stream,options={},emit}){
      Object.assign(this,{id,generation,stream,options,emit,status:"preparing",store:new EvidenceStore(),gate:new VisualGate(options.ocrEngine==="vision-cloud"?{mode:"vision"}:{}),imageQueue:[],audioQueue:[],imageBytes:0,gaps:[],debug:[],debugAt:performance.now(),counts:{visual:0,audio:0},revision:0,disposed:false,progress:null});
