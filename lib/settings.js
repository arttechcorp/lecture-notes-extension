...
const DEFAULTS = {
  ...
  // 노트 생성 때 외부로 무엇을 보낼지.
  //   none    아무것도 안 보냄 (기기 안에서만 생성)
  //   summary 기기 안에서 먼저 요약하고 그 결과만 보냄 — 원문 표현이 나가지 않는다
  //   full    스크립트 원문을 그대로 보냄
  remoteScope: "summary",
  // auto: Nano가 지금 당장 쓸 수 있으면 Nano, 아니면 Tesseract.
  // 다운로드가 필요한 상태에서 수 GB를 받게 만들지 않는다.
  ocrEngine: "auto", // "auto" | "nano" | "tesseract"
