...
(() => {
  ...
  class VisualGate {
    constructor(){this.previous=null;this.recognized=null;this.submitted=null;this.pending=false;this.changedAt=0;this.lastMotion=0;this.slideId=0;}
    inspect(canvas,now=performance.now(),force=false){
      ...
      const accept=force||(!this.pending&&!duplicate&&(!this.recognized||(changed&&(now-this.lastMotion>=600||now-this.changedAt>=2500))));
